...
if exists('java_highlight_functions')
  if java_highlight_functions ==? 'indent'
    ...
    "                                public      return type                                function name     | constructor name
    "                                private
    "                                static
    syn match javaFuncDef "^\s\+\%(\w\+\s\+\)*\%([[:alnum:]\.]\+\)\%(<[^>]*>\)\?\%(\[\]\)*\s\+\%([a-z][A-Za-z0-9_$]*\|[A-Z][A-Za-z0-9_$]*\)\s*(\@=" contains=javaScopeDecl,javaType,javaStorageClass,javaComment,javaLineComment,@javaClasses,javaFuncName,javaTemplate,javaComma,@javaTop nextgroup=javaFuncParams
    syn match javaFuncDef "^\s\+\%(\w\+\s\+\)*\%(<.*>\s\+\)\?\%([[:alnum:]\.]\+\)\%(<[^(){}]*>\)\?\%(\[\]\)*\s\+\%([a-z][A-Za-z0-9_$]*\|[A-Z][A-Za-z0-9_$]*\)\s*(\@=" contains=javaScopeDecl,javaType,javaStorageClass,javaComment,javaLineComment,@javaClasses,javaFuncName,javaTemplate,javaComma,@javaTop nextgroup=javaFuncParams

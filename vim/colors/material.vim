...
exe 'hi! CursorLineNR    ctermfg='     .s:brightcyan   .' ctermbg='   .s:none       .' cterm=none'
...
exe 'hi! Function        ctermfg='     .s:blue         .' ctermbg='   .s:none        .' cterm=none'
...
exe 'hi! SpecialChar     ctermfg='     .s:cyan         .' ctermbg='   .s:none        .' cterm=bold'
...
exe 'hi! diffAdded       ctermfg='     .s:brightgreen  .' ctermbg='   .s:none        .' cterm=none'

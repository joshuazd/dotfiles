...
exe 'hi! Folded          ctermfg=' .s:t_lgrey   .' guifg=' .s:g_lgrey   .' ctermbg=' .s:t_mgrey   .' guibg=' .s:g_mgrey   .' cterm=none gui=none'
...
exe 'hi! Builtin         ctermfg=' .s:t_orange  .' guifg=' .s:g_orange  .' ctermbg=' .s:t_bg      .' guibg=' .s:g_bg      .' cterm=none gui=none'

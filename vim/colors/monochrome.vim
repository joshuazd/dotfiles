...
call s:h('Constant',        s:grey22,       s:background,   'bold')
call s:h('String',          s:grey18,  s:background,   'none')
call s:h('StringDelimiter', s:grey23,      s:background,   'none')
call s:h('Character',       s:grey22,       s:background,   'bold')
call s:h('Number',          s:grey22,       s:background,   'bold')
call s:h('Boolean',         s:grey22,       s:background,   'bold')
call s:h('Float',           s:grey22,       s:background,   'bold')
call s:h('Identifier',      s:grey22,     s:background,   'none')
call s:h('Function',        s:grey14,       s:background,   'underline')
call s:h('Primitive',       s:grey13, s:background,   'italic')

call s:h('Statement',       s:grey11,     s:background,   'none')
call s:h('Conditional',     s:grey11,     s:background,   'none')
call s:h('Repeat',          s:grey11,     s:background,   'none')
call s:h('Label',           s:grey11,     s:background,   'none')
call s:h('Operator',        s:grey9,      s:background,   'none')
call s:h('Keyword',         s:grey11,     s:background,   'none')

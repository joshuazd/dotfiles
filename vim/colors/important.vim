...
call s:h('Constant',        s:white,      s:background,   'none')
...
call s:h('Boolean',         s:white,      s:background,   'none')
...
call s:h('Exception',       s:red,        s:background,   'none')

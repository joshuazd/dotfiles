...
if exists('g:xml_syntax_folding')
    ...
    syn region   xmlRegion
        ...
        \ matchgroup=xmlTagPunct end=+/>+
        \ fold
        \ contains=xmlJsonRegion,xmlSqlRegion,xmlJavaScriptRegion,xmlTag,xmlEndTag,xmlCdata,xmlRegion,xmlComment,xmlOperator,xmlEntity,xmlProcessing,@xmlRegionHook,@Spell
        \ keepend
        \ extend
        \ concealends

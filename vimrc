...
" Don't insert comment when using 'o'
...
" make leader a more sane keybinding
let mapleader = "\<Space>"

" remap localleader
let maplocalleader = ","

" Change tabs to be 2 spaces for xml files
...
if has("gui_running")
    ...
    " Set line number color as darkgray
...
if has("gui_running")
    ...
    let g:airline#themes#simple#palette.normal.airline_error = [
                \ s:ER[0], s:ER[1], s:ER[2], s:ER[3]
                \ ]

    let g:airline#themes#simple#palette.normal_modified.airline_error =
                \ g:airline#themes#simple#palette.normal.airline_error

    let g:airline#themes#simple#palette.insert.airline_error =
                \ g:airline#themes#simple#palette.normal.airline_error

    let g:airline#themes#simple#palette.insert_modified.airline_error =
                \ g:airline#themes#simple#palette.normal.airline_error

    let g:airline#themes#simple#palette.visual.airline_error =
                \ g:airline#themes#simple#palette.normal.airline_error

    let g:airline#themes#simple#palette.visual_modified.airline_error =
                \ g:airline#themes#simple#palette.normal.airline_error

    let g:airline#themes#simple#palette.replace.airline_error =
                \ g:airline#themes#simple#palette.normal.airline_error

    let g:airline#themes#simple#palette.replace_modified.airline_error =
                \ g:airline#themes#simple#palette.normal.airline_error
" }}}

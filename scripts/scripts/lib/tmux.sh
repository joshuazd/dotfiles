...
run_worktree_popup() {
  ...
  local popup_command
  # Bordered on purpose: this popup shows scrolling command output, and the
  # border is what separates it from the pane behind. It tears while something
  # animates behind it, which is accepted for the legibility.
